...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2018 at 05:20 PM
...
(4, 'chinamotors', 'Part-Time', 'http://localhost/pempleos/uploads/f2d8b9a7db45142d996f1862aed116b8.png', 'asdasda', 'asdasd', 'asdas', 2, 'asdasdasdasdasd', '', 'soneric021@gmail.com', 3, '2018-11-04 20:59:06');
...
(1, 'Admin', 'dobki36@gmail,com', 0, '123456789'),
(2, 'asdas', 'asdas', 1, 'asdas'),
(3, 'Ericson Montero', 'Soneric021@gmail.com', 2, '123456789er');
...
ALTER TABLE `employee` ADD FULLTEXT KEY `compañia` (`compañia`);
ALTER TABLE `employee` ADD FULLTEXT KEY `ubicacion` (`ubicacion`);
ALTER TABLE `employee` ADD FULLTEXT KEY `posicion` (`posicion`);
